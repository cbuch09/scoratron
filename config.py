...
TEAM_COLORS = {
    ...
    "TEN": ( 75, 146, 219),  "DEN": (251, 79,  20),   "LV":  (165, 130,  82),
    "LAC": (  0, 128, 198),  "SEA": (  0, 34, 68),    "ARI": (151, 35,  63),
    "LAR": (  0, 53, 148),   "GB":  ( 24, 48,  40),   "MIN": ( 79, 38, 131),
    "CHI": (  11, 22, 42),   "DET": (  0, 118, 182),  "ATL": (167, 25,  48),
    "CAR": (  0, 133, 202),  "NO":  (211, 188, 141),  "TB":  (213, 10,  10),
    "WAS": ( 63,  16,  16),  "NYG": ( 1, 35, 82),
    # NBA
    ...
    "SAC": ( 91, 43, 130),   "HOU": (206, 17,  65),   "NO":  (  0,  22,  65),
